...
class ColorConfig:
    mode: str = "lut"
    lut_path: str = "Blackmagic Design/Blackmagic Gen 5 Film to Extended Video.cube"
    fallback_lut_path: str = "Blackmagic Design/Blackmagic Film to Extended Video v4.cube"
...
def load_config(config_path: Optional[str] = None) -> AppConfig:
    ...
    color = ColorConfig(
        ...
        lut_path=str(color_data.get("lut_path", "Blackmagic Design/Blackmagic Gen 5 Film to Extended Video.cube")),
        fallback_lut_path=str(color_data.get("fallback_lut_path", "Blackmagic Design/Blackmagic Film to Extended Video v4.cube")),
    )
    ...
    davinci = DaVinciConfig(
        ...
        auto_start_headless=bool(davinci_data.get("auto_start_headless", True)),
