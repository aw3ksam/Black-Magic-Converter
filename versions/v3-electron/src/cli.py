"""
Unified Command-Line Interface for BRAW Video Converter (v3.1).
Standalone transcode engine powered by Blackmagic RAW SDK and FFmpeg.
...
def cmd_watch(args):
    ...
    logger.info("Initializing BRAW Hot Folder Watcher (v3.1 Standalone Engine)...")
...
def cmd_test_env(args):
    ...
    print("\n" + "=" * 60)
    print(" BRAW Video Converter — Environment Diagnostics (v3.1)")
    print("=" * 60)
